---
name: keploy
description: Use this skill when the user asks about Keploy API tests in this repo — running sandbox tests, recording or rerecording mocks, replaying captured runs, generating new tests for an endpoint, fixing a failing test, wiring CI, or any reference to `keploy/`, `keploy/api-tests/`, sandbox tests, integration tests, mocks, or test suites.
---
